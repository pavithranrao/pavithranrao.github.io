...
[Github solution link](https://github.com/pavithranrao/rustlings/blob/main/exercises/00_intro/intro1.rs)
```rust
// intro1.rs
//
...
[Github solution link](https://github.com/pavithranrao/rustlings/blob/main/exercises/00_intro/intro2.rs)
```rust
// intro2.rs
//
